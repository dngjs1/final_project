...
public class ProductJoinCategory {
	...
	public ProductJoinCategory(int product_code, int price, String product_name, Date release_date, String country,
			String real_size, String p_board_content, Date write_date, String p_category_code, String p_category_name) {
		super();
	...
	public String toString() {
		return "ProductJoinCategory [product_code=" + product_code + ", price=" + price + ", product_name="
				+ product_name + ", release_date=" + release_date + ", country=" + country + ", real_size=" + real_size
				+ ", p_board_content=" + p_board_content + ", write_date=" + write_date + ", p_category_code="
				+ p_category_code + ", p_category_name=" + p_category_name + "]";
	}
