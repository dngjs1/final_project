				...
				<div class = "bottom" colspan = "2">
						...
						<dl>
							...
							<dt>포인트</dt>
								<dd>
									<div class = "dd_left">
										<input type = "text" class = "text02" value = "0" style = "width:137px;" numberonly = "true">&nbsp;P
									</div>
									
									<div class = "dd_right">
										<label for = "#">
											<input type = "checkbox" id = "#" class = "checkbox">모두사용(포인트 <em style = "font-style: normal; font-weight: bold;">5,000P</em>)
										</label>
									</div>
								</dd>
						</dl>
