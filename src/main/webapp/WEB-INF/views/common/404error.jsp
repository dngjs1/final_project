...
%>
<div class="container" style = "background-color:#395D6D;">
...
<div class="text">
  <div class="text-inner">
    ...
    <div id="home" class="button" style = "vertical-align: middle;">
      <a href="/shop/" style = "text-decoration: none;"><h2 style = "padding-bottom:0;">뒤로가기</h2></a>
    </div>
	</div>
