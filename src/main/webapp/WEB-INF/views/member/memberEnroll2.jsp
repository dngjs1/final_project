...
$(function(){
 ...
 function validate(){
	...
	if (!phone.test($('#phone').val())) {
	 ...
	 if(!reg_pwd.test($.trim($('#member_pw').val()))){
...
<li>
	...
	<div class = "member_wrap">
		...
		<form name = "frm" method="post" enctype = "multipart/form-data" onsubmit='return validate();' action="${pageContext.request.contextPath}/memberEnrollEnd.do" >
			...
			<!-- 4글자 이상 입력 -->
			<li>
				<input type = "text" id = "member_id" name = "member_id" class = "text" placeholder="*아이디 입력" style = "ime-mode:disabled; width:100%;border:solid gray" tabindex = "1" required>
			...
			<!-- 이름 입력 -->
			<li>
				<input type = "text" id = "member_name" name ="member_name" class = "text" placeholder="*이름 입력" style = " width:100%; border:solid gray" tabindex = "2" required>
			...
			<!-- 비밀번호 확인 -->
			<li>
				<input type="password" id="member_pw2"  class = "text" placeholder="*비밀번호 확인 " tabindex="4" style="width:100%; border:solid gray" onkeyup="passwordCheck(this)" required>
				<p class = "example" id = "rePassResult">
				</p>
			</li>
			<!-- 생년월일 선택 -->
			<li>
				<input type = "date" id = "birthday" name = "birthday" class = "text" placeholder="*생년월일 입력" style = " width:100%; border:solid gray" tabindex = "5" required>
			...
			<!-- 휴대전화 입력 -->
			<li>
				<input type = "text" id = "phone" name = "phone" class = "text" placeholder="*휴대폰번호입력" style = " width:100%; border:solid gray" tabindex = "5" required>
			...
			<li>
				<input type = "text" id = "roadAddress" name = "address" class = "text" placeholder="*주소" style = "width : 450px; border:solid gray" required>
			...
			<li>
				<input type = "text" id = "detail_address" name = "detail_address" class = "text" placeholder="*상세주소입력" style = " width:100%; border:solid gray" tabindex = "5" required>
				<p class = "example" id = "#">주소찾기 버튼으로 주소를 찾은 후 나머지 주소를 입력해주세요</p>
			</li>
			
			<li>
				<input type = "text" id = "post_no" name = "post_no" class = "text" placeholder="*우편번호입력" style = " width:100%; border:solid gray" tabindex = "5" required>
