...
<div class = "col-10">
	...
	<div class = "mypage_wrap">
		<h2 class = "mypage_title02"><i class="card_buy far fa-credit-card"></i>My 대여 내역</h2>
			...
			<tbody>
				...
				<c:when test="${not empty orderList}">
					...
					<tr>
			               ...
			               <td><span>${order.MEMBER_ID}</span></td>
			               <td><span>${order.PHONE}</span></td>
			               <td><span>${order.ADDRESS}${order.DETAIL_ADDRESS }</span></td>
